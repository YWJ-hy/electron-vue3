...
export class CommonWindowEvent {
  ...
  public static listen() {
    ...
    ipcMain.handle("maxmizeWindow", (e) => {
      console.log("🚀 ~ file: CommonWindowEvent.ts:15 ~ CommonWindowEvent ~ ipcMain.handle ~ e:", e)
      this.getWin(e)?.maximize();
    });

    ipcMain.handle("unmaximizeWindow", (e) => {
      console.log("🚀 ~ file: CommonWindowEvent.ts:19 ~ CommonWindowEvent ~ ipcMain.handle ~ e:", e)
